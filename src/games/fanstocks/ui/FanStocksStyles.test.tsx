...
import draftRoom from '../../../assets/generated/fanstocks/draft-room.webp?url'
...
describe('FanStocks CSS contract', () => {
  ...
  it('loads the generated local draft-room atmosphere with a fallback overlay', () => {
    expect(draftRoom).toContain('draft-room.webp')
    expect(css).toContain("url('../../assets/generated/fanstocks/draft-room.webp')")
